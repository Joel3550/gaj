function agentRouteConfiguration(app){
...
agentRouteConfiguration.prototype.init = function() {
...
agentRouteConfiguration.prototype.processRoutes = function() {
...
agentRouteConfiguration.prototype.addRoutes = function() {
    ...
    self.routeTable.push({
        ...
        requestType: 'get',
        requestUrl: '/formAjoutAgent',
        callbackFunction: function (request, response) {
            response.render('contents/agent/formAjoutAgent', {
                title: "Agent",
    ...
    self.routeTable.push({
        ...
        requestType: 'get',
        requestUrl: '/supprimerAgent_url/:idAgent',
        callbackFunction: function (request, response) {

            var dao = require('../serveur/dao/agent/agentDao.js');
            dao.agentDao.supprimerAgent(request.params.idAgent);
            response.render('contents/agent/listeAgents', {
                title: "Agent",
                label: "Liste des agents"
            })
...
module.exports = agentRouteConfiguration;